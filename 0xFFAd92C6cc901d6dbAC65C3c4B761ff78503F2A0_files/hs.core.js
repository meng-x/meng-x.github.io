            ...
            darkMode: function () {
                ...
                $('#darkModaBtn').on('click', function () {
                    ...
                    if ($('body').hasClass('dark-mode')) {                      
                        ...
                        $('#logo-header').attr('src', '/images/logo-ether-white.png?v=0.01');
                        window.mode = 'dark';
                        $("iframe").each(function () {
                            var src = $(this).contents().find('body');
                            src.addClass('dark-mode');
                            src.attr('style', 'background: #012137 !important;');
                            ...
                            if (subIframe.length > 0) {
                                ...
                                var style = 'background: #012137 !important;';
                        ...
                        $('#logo-header').attr('src', '/images/logo-ether.png?v=0.01');        
                        window.mode = 'normal';
                        $("iframe").each(function () {
                            var src = $(this).contents().find('body');
